...
namespace SIL.GenerateHCConfigForFLExTrans
{
    internal class ConsoleLogger : ILcmUI, IHCLoadErrorLogger
    {
        ...
        {
            Console.WriteLine(
                "The form \"{0}\" contains an undefined phoneme at {1}.",
                str,
                errorPos
            );
        }
        ...
        {
            Console.WriteLine(
                "The affix process \"{0}\" is invalid.",
                affixProcess.Form.BestVernacularAlternative.Text
            );
        }
        ...
        {
            Console.WriteLine(
                "The phoneme \"{0}\" does not contain any valid graphemes.",
                phoneme.Name.BestAnalysisVernacularAlternative.Text
            );
        }
        ...
        {
            Console.WriteLine(
                "The phoneme \"{0}\" has the same grapheme as another phoneme.",
                phoneme.Name.BestAnalysisVernacularAlternative.Text
            );
        }

        public void InvalidEnvironment(
            IMoForm form,
            IPhEnvironment env,
            string reason,
            IMoMorphSynAnalysis msa
        ...
        {
            Console.WriteLine(
                "The environment \"{0}\" is invalid. Reason: {1}",
        ...
        {
            Console.WriteLine(
                "The reduplication form \"{0}\" is invalid. Reason: {1}",
                form.Form.VernacularDefaultWritingSystem.Text,
                reason
            );
        }
    }
