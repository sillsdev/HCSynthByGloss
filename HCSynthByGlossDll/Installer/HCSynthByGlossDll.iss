...
#define MyAppName "Hermit Crab Synthesis for FLExTrans DLL"
#define MyAppVersion "1.6.5 Beta"
#define MyAppPublisher "SIL Iternational"
#define MyAppURL "https://software.sil.org/"
#define MyAppExeName "HCSynthByGlossDll.dll"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{CCD6E6F6-34B9-48DC-8810-D5370C0B4E9B}
AppName={#MyAppName}
...
OutputBaseFilename=HCSynthByGlossDllSetup
...
[Files]
Source: "..\bin\x64\Release\HCSynthByGlossDll.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\bin\x64\Release\HCSynthByGlossDll.dll.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\bin\x64\Release\HCSynthByGlossDll.pdb"; DestDir: "{app}"; Flags: ignoreversion
